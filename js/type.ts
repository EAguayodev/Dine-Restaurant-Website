...
const picture = eventImage ? eventImage.parentElement : null;
const sources = picture.querySelectorAll("source");

btnGathering.addEventListener('click', () => {
    eventHeading.textContent = 'Family Gathering';
    eventDescription.textContent = 'We love catering for entire families. So please bring everyone along for a special meal to remember. We’ll provide a memorable experience for all ages.';
...
btnSpecial.addEventListener('click', () => {
    ...
    eventDescription.textContent = 'Whether it’s a romantic dinner or special date you’re celebrating with others we’ll look after you. We’ll be sure to mark your special date with an unforgettable meal.';
...
btnSocial.addEventListener('click', () => {
    ...
    eventDescription.textContent = 'Are you looking to have a larger social event? No problem! We’re more than happy to cater for big parties. We’ll work with you to make your event a hit with everyone.';
...
// Reservation form with date | time picker | number of guests selection | Name | Email Address | reservation button | reservation confirmation message
