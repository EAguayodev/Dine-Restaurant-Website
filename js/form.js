...
form.addEventListener("submit", (e) => {
  ...
  const subSelection = document.querySelector(".am-pm-submenu");
  ...
  if (monthInput.value.trim() === "" && dayInput.value.trim() === "" && yearInput.value.trim() === "") {
    ...
    isValid = false;
  } else if (monthInput.value.trim() !== "" && dayInput.value.trim() === "" && yearInput.value.trim() === "") {
    dateText.classList.add("label-error");
    dateErrorText.classList.add("error-show");
    monthInput.classList.add("error");
    dayInput.classList.add("error");
   ...
   if (hourInput.value.trim() === "" && minuteInput.value.trim() === "" && ampmInput.value.trim() === "") {
